...
extends Menu {
    ...
    public void build() {
        ...
        this.inventory.setItem(11, Items.of(won ? Material.LIME_DYE : Material.RED_DYE).miniName(won ? "<bold><gradient:#8BF58B:#2EB82E>\u1d20\u026a\u1d04\u1d1b\u1d0f\u0280\u028f</gradient></bold>" : "<bold><gradient:#FF6B6B:#8B0000>\u1d05\u1d07\ua730\u1d07\u1d00\u1d1b</gradient></bold>").lore("&7You: &f" + this.name(me), "", "&7Score: &f" + this.duel.getScoreFor(me), "&7Hits: &f" + this.duel.getHits(me), "&7Damage: &f" + MatchSummaryMenu.fmt(this.duel.getDamageDealt(me)) + " &c\u2764", "", "&7Streak: &6" + this.plugin.getStatsManager().getStreak(me), "&7Wins: &b" + this.plugin.getStatsManager().getWins(me)).hideTooltip().build());
